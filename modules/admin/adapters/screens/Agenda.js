...
export default function Agenda() {
  ...
  const [modalNameClient, setModalNameClient] = useState("");
  ...
  const agendarCita = async () => {
    Alert.alert(
      "Confirmación",
      "¿Estás seguro de agendar la cita?",
      [
        {
          text: "Cancelar",
          style: "cancel",
        },
        {
          ...
          onPress: async () => {
            try {
              ...
              setnameClient(modalNameClient);
              setTypeOfService(typeOfService);
              setDay(selectedModalDay);
              ...
              <View key={cita.id} style={styles.cardContainer}>
                ...
                <View style={styles.buttonContainer}>
                  <TouchableOpacity
                    ...
                    onPress={() => {
                      setSelectedModalDay(cita.day); // Aquí asignamos el valor de cita.day al día seleccionado en el modal
                      setModalNameClient(cita.nameUser);
                      ...
                      <View style={styles.modalContent}>
                        <View key={cita.id}>
                          ...
                          <TextInput
                            ...
                            value={modalNameClient}
                            onChangeText={(text) => {
                              setModalNameClient(text);
                            }}
                          />
                          <TextInput
                            style={styles.input}
                            placeholder="Ingresa el día de la cita "
                            value={selectedModalDay}
                            onChangeText={(text) => {
                              setSelectedModalDay(text);
                            }}
                          />
                          ...
                          {isLoading ? (
                            ...
                            <View style={styles.containerColum}>
                              <TouchableOpacity
                                ...
                                onPress={() => {
                                  if (fieldsCompleted) {
                                    agendarCita(); // Call the agendarCita function
                                  } else {
